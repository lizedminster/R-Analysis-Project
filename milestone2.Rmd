...
```{r}
plotcluster(cleaned_data_21.scaled, fit.km5$cluster, main = "Figure 3.1.1: K-Means Clustering 2021")
plotcluster(cleaned_data_11.scaled, fit.km4$cluster, main = "Figure 3.1.2: K-Means Clustering 2011")
```
...
title("Figure 3.1.3: MClust Clustering 2021")

model.dr_11 <- MclustDR(model.clus_11)
plot(model.dr_11, what = "contour")
title("Figure 3.1.4: MClust Clustering 2011")
```
